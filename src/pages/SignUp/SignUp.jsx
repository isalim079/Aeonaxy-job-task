...
const SignUp = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const userData = { name, email, checkbox };
    ...
    return (
        <div className="">
            ...
            <div className={`${activeSteps === 0 && 'grid grid-cols-2 gap-20 h-screen'}`}>

                <div className={`bg-[#F3D184] ${activeSteps !== 0 && 'hidden'}`}>
                ...
                <div className="">
                    ...
                    <div className={`${activeSteps === 0 && 'mt-10'}`}>
                        ...
                        >
                            ...
                            {activeSteps === 0 && <div className="w-full max-w-[65%]">
                                {/* input fields */}
